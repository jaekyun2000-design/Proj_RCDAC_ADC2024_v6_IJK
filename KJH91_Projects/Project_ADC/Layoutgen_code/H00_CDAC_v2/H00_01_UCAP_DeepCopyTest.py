...
class _UCAP(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        self._DesignParameter['SRF_ECAP_deepcopy'] = copy.deepcopy(self._DesignParameter['SRF_ECAP'])
        self.rename_srf_prefix(self._DesignParameter['SRF_ECAP_deepcopy'],'SRF_ECAP','SRF_ECAP_deepcopy')
        self._DesignParameter['SRF_ECAP_deepcopy']['_XYCoordinates'] = [[0, -800]]

        # tmp_tmp = self.get_param_KJH4('SRF_ECAP_deepcopy')
        print('##############################')
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ02_H00_01_UCAP_DeepCopyTest'
    cellname = 'H00_00_UCAP'
    ...
    with open('LayoutObj_version1.pkl', 'wb') as f:
