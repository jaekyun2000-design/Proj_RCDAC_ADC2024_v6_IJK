...
## Nor(Pullup,Pmos)
    ...
    _PMOSB_ChannelLength         = 30,       # Number
        ...
        _Caculation_Parameters1['_Drain_Comb_POpinward_TF']      = False
        ...
        _Caculation_Parameters2['_Source_Via_TF']                = True
        _Caculation_Parameters2['_Source_Via_Close2POpin_TF']    = True
        _Caculation_Parameters2['_Source_Comb_TF']               = True
        _Caculation_Parameters2['_Source_Comb_POpinward_TF']     = False
        _Caculation_Parameters2['_Source_Comb_Length']           = None

        _Caculation_Parameters2['_Drain_Via_TF']                 = True
        _Caculation_Parameters2['_Drain_Via_Close2POpin_TF']     = False
        ...
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters2['_Source_Comb_Length'] = PMOSB_length
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_D02_01_Pullup_Fixed'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'D02_01_Pullup_v0_99'
