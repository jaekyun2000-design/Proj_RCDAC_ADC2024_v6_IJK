...
## Define Class
class _Inv(StickDiagram_KJH1._StickDiagram_KJH):
...
#Inverter
    ...
    # Common
        # Pbody_Pulldown(NMOS)
        _Inv_Pbody_XvtTop2Pbody         =None,  # Number/None(Minimum)
        # Nbody_Pullup(PMOS)
        _Inv_Nbody_Xvtdown2Nbody        =None,  # Number/None(Minimum)
        # PMOS and NMOS Height
        _Inv_PMOSXvt2NMOSXvt            =1000,  # number
...
#Inverter
    ...
    # Common
        ...
        print('##############################')
        ## Pre-defined
        _Inv_NMOS_POGate_Comb_length = None
        _Inv_PMOS_POGate_Comb_length = None
        _Inv_NMOS_POGate_ViaMxMx = [0,1]
        _Inv_PMOS_POGate_ViaMxMx = [0,1]
        _Inv_Pbody_NumCont =2
        _Inv_Nbody_NumCont =2
        ...
        _Caculation_Parameters['_NumberofGate']                 = _Inv_NumberofGate
        _Caculation_Parameters['_ChannelWidth']                 = _Inv_NMOS_ChannelWidth
        _Caculation_Parameters['_ChannelLength']                = _Inv_ChannelLength
        _Caculation_Parameters['_GateSpacing']                  = None
        _Caculation_Parameters['_SDWidth']                      = None
        _Caculation_Parameters['_XVT']                          = _Inv_XVT
        ...
        _Caculation_Parameters['_Source_Comb_TF']               = False
        ...
        _Caculation_Parameters['_PODummy_Placement']            = None
        ...
        _Caculation_Parameters['_POGate_Comb_length']           = _Inv_NMOS_POGate_Comb_length
        _Caculation_Parameters['_POGate_Via_TF']                = True
        _Caculation_Parameters['_POGate_ViaMxMx']               = _Inv_NMOS_POGate_ViaMxMx
        ...
        _Caculation_Parameters['_NumCont']     = _Inv_Pbody_NumCont
        ...
        if _Inv_Pbody_XvtTop2Pbody == None:
                            ## Calculate
            ...
            target_coordx = np.round( 0.5 * (tmp1_1['_Mostright']['coord'][0] + tmp1_1['_Mostleft']['coord'][0]) )
                                    ## Y
            tmp1_2 = self.get_param_KJH4('SRF_NMOS','BND_{}Layer'.format(_Inv_XVT))
            ...
            Scoord = tmp3[0][0]['_XY_origin']
                                ## Cal
            New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
            New_Scoord[1] = New_Scoord[1] - _Inv_Pbody_XvtTop2Pbody
            tmpXY.append(New_Scoord)
                        ## Define Coordinates
            self._DesignParameter['SRF_Pbody']['_XYCoordinates'] = tmpXY
        ...
        _Caculation_Parameters['_NumberofGate']                 = _Inv_NumberofGate
        _Caculation_Parameters['_ChannelWidth']                 = _Inv_PMOS_ChannelWidth
        _Caculation_Parameters['_ChannelLength']                = _Inv_ChannelLength
        _Caculation_Parameters['_GateSpacing']                  = None
        _Caculation_Parameters['_SDWidth']                      = None
        _Caculation_Parameters['_XVT']                          = _Inv_XVT
        ...
        _Caculation_Parameters['_POGate_Comb_TF']               = True
        _Caculation_Parameters['_POGate_Comb_length']           = _Inv_PMOS_POGate_Comb_length
        _Caculation_Parameters['_POGate_Via_TF']                = True
        _Caculation_Parameters['_POGate_ViaMxMx']               = _Inv_PMOS_POGate_ViaMxMx
        ...
        self._DesignParameter['SRF_PMOS']['_XYCoordinates'] = [[0, 0]]
                        ## Calculate
                            ## Target_coord: _XY_type1
        tmp1 = self.get_param_KJH4('SRF_NMOS','BND_{}Layer'.format(_Inv_XVT))
        target_coord = tmp1[0][0][0]['_XY_up']
                            ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('SRF_PMOS','BND_{}Layer'.format(_Inv_XVT))
        ...
        Scoord = tmp3[0][0]['_XY_origin']
                            ## Cal
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        New_Scoord[1] = New_Scoord[1] +  _Inv_PMOSXvt2NMOSXvt
        tmpXY.append(New_Scoord)
                    ## Define Coordinates
        ...
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_Length']      = None
        _Caculation_Parameters['_NumCont']     = _Inv_Nbody_NumCont
        _Caculation_Parameters['_Vtc_flag']    = False
        ...
        if _Inv_Nbody_Xvtdown2Nbody == None:
                            ## Calculate
                                ## Target_coord: _XY_type1
                                    ## X
            tmp1_1 = self.get_param_KJH4('SRF_PMOS', 'BND_{}Layer'.format(_Inv_XVT))
            ...
            self._DesignParameter['SRF_Nbody']['_XYCoordinates'] = tmpXY
                            ...
                            ## Calculate
                                ## Target_coord: _XY_type1
            tmp1 = self.get_param_KJH4('SRF_PMOS','BND_{}Layer'.format(_Inv_XVT))
            ...
            Scoord = tmp3[0][0]['_XY_origin']
                                ## Cal
            New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
            New_Scoord[1] = New_Scoord[1] + _Inv_Nbody_Xvtdown2Nbody
            tmpXY.append(New_Scoord)
                        ## Define Coordinates
            self._DesignParameter['SRF_Nbody']['_XYCoordinates'] = tmpXY
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_Q03_00_Inv_Fixed'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'Q03_00_Inv_v1_500'
...
#Inverter
    ...
    ## Gen Object:
    LayoutObj = _Inv(_DesignParameter=None, _Name=cellname)
