...
_Driver_DecimationFactor=[0, 0, 0, 0, 0 ,0],
## SAR Logic
	...
	## DAC PreDriver
		## Inverter Chain
			...
			## Inverter Chain
				## Inv1 common
			_LOGIC_DACPreDrv_NumberofGate=[[1, 2, 4, 8], [1, 2, 4, 8], [1, 2, 4, 8], [2, 2, 2, 2, 2],  [1]],  # Vector
			_RDAC_InputComple_Inv_NumofGate = [10,1], # Vector, _LOGIC_DACPreDrv_NumberofGate + _RDAC_InputComple_Inv_NumofGate로 입력됨
	...
	## Decoder
		...
		# Unit
			## Comoon
				...
				# Inputs of Nand,Nor
				_RDAC_Decoder_Unit_Num_EachStag_input = [3], # ex) [2,3,4] 가장 마지막단(TG driving) nand input4, Nor input3, Nand input2, Nor input2 ...
				# Power rail
					# Pbody_Pulldown(NMOS)
...
_Driver_DecimationFactor=[2, 0, 0, 0],
## SAR Logic
	## Clock Tree (Driving SAR Logic)
		## Clock Tree Updward (CLK Source Tree, CLK Samp Tree)
			## CLK Buffer Unit
...
#RDAC and Decoder
	...
	## Decoder
		...
		# ## CDAC Decimation
		#
		# 	## Decimation on Common Cent only
		# if (_CDACDrv_ArrangedTF == False):
		# 	## No folding
		# 	if (_CDAC_FoldingTF == False):
		...
		# 				else:
		# 					if i % tmp != 0:
		# 						del self._DesignParameter['SRF_CDAC_Pos']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['SRF_{}C_DriverCell'.format(2 ** (_NumofCbit - 1 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Pos']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['BND_{}C_Driver_Input_Vtc_M2'.format(2 ** (_NumofCbit - 1 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Pos']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['BND_{}C_Driver_Drain_Vtc_M4'.format(2 ** (_NumofCbit - 1 - j))]['_XYCoordinates'][i]
		#
		# 						del self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['SRF_{}C_DriverCell'.format(2 ** (_NumofCbit - 1 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['BND_{}C_Driver_Input_Vtc_M2'.format(2 ** (_NumofCbit - 1 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['BND_{}C_Driver_Drain_Vtc_M4'.format(2 ** (_NumofCbit - 1 - j))]['_XYCoordinates'][i]
		# 					else:
		# 						pass
		# 	## Folding
		# 	else:
		...
		# 				else:
		# 					if i % tmp != 0:
		# 						del self._DesignParameter['SRF_CDAC_Pos']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_UpperHalf']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['SRF_{}C_DriverCell'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Pos']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_UpperHalf']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['BND_{}C_Driver_Input_Vtc_M2'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Pos']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_UpperHalf']['_DesignObj']._DesignParameter['BND_{}C_Driver_Drain_Vtc_M4'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		#
		# 						del self._DesignParameter['SRF_CDAC_Pos']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_LowerHalf']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['SRF_{}C_DriverCell'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Pos']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_LowerHalf']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['BND_{}C_Driver_Input_Vtc_M2'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Pos']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_LowerHalf']['_DesignObj']._DesignParameter['BND_{}C_Driver_Drain_Vtc_M4'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		#
		# 						del self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_UpperHalf']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['SRF_{}C_DriverCell'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_UpperHalf']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['BND_{}C_Driver_Input_Vtc_M2'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_UpperHalf']['_DesignObj']._DesignParameter['BND_{}C_Driver_Drain_Vtc_M4'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		#
		# 						del self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_LowerHalf']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['SRF_{}C_DriverCell'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_LowerHalf']['_DesignObj']._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['BND_{}C_Driver_Input_Vtc_M2'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		# 						del self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._DesignParameter['SRF_CDACWtDriver']['_DesignObj']._DesignParameter['SRF_CDAC_LowerHalf']['_DesignObj']._DesignParameter['BND_{}C_Driver_Drain_Vtc_M4'.format(2 ** (_NumofCbit - 2 - j))]['_XYCoordinates'][i]
		#
		# 					else:
		# 						pass
		# else:
...
if __name__ == '__main__':
	...
	'Schematic version: Proj_RcdacSar_A01_schematic_3/D10_TopSchematic_A04_A00_Top_LVS'
	## LibraryName: ex)Proj_ADC_A_my_building_block
	libname = 'Proj_ZZ01_S00_00_R00C13H06L00_ADC2024RcDacSAR'
	## CellName: ex)C01_cap_array_v2_84
	cellname = 'S00_00_R00C13H06L00_99'
...
_NumofCbit=6, #-->check
_NumofRbit=4, #-->check
_Driver_DecimationIfDriverPlacedInCommonCentroid = False, #-->check
_Driver_DecimationFactor=[0, 0, 0, 0, 0], #-->check
...
## SAR Logic
	## Clock Tree (Driving SAR Logic)
		## Clock Tree Updward (CLK Source Tree, CLK Samp Tree)
			## CLK Buffer Unit
				## Common
				_LOGIC_CLKBufTreeTop_UnitBuf_XVT='SLVT', #-->check
				## Nmos
				_LOGIC_CLKBufTreeTop_UnitBuf_NMOS_NumberofGate=2,  # Number #-->check
				_LOGIC_CLKBufTreeTop_UnitBuf_NMOS_ChannelWidth=400,  # Number #-->check
				_LOGIC_CLKBufTreeTop_UnitBuf_NMOS_ChannelLength=30,  # Number #-->check
				## Pmos
				_LOGIC_CLKBufTreeTop_UnitBuf_PMOS_NumberofGate=2,  # Number #-->check
				_LOGIC_CLKBufTreeTop_UnitBuf_PMOS_ChannelWidth=800,  # Number  #-->check
				_LOGIC_CLKBufTreeTop_UnitBuf_PMOS_ChannelLength=30,  # Number #-->check
				# Height
				_LOGIC_CLKBufTreeTop_UnitBuf_PMOSXvt2NMOSXvt=446,  # number #-->check
			## Clock Buffer Tree structure
			_LOGIC_CLKBufTreeTop_BufTree1and2_NumOfStage=4,  # len[Buf0, Buf1, ... ] 스테이지 수 (아래 버퍼 사이즈 리스트의 길이와 같아야 함.) #-->check
			_LOGIC_CLKBufTreeTop_BufTree1_SizeofEachStage=[1, 2, 4, 8],  # CLKSampBuf: [Buf0, Buf1, Buf2 ...] #-->check
			_LOGIC_CLKBufTreeTop_BufTree2_SizeofEachStage=[1, 2, 4, 8],  # CLKSrcBuf: [Buf0, Buf1, Buf2 ...] #-->check
			_LOGIC_CLKBufTreeTop_XOffSet=+45, #-->check
		## Clock Tree Dnward (CLK Source Tree, CLK Samp Tree)
			## CLK Buffer Unit
				## Common
				_LOGIC_CLKBufTreeBot_UnitBuf_XVT='SLVT', #-->check
				## Nmos
				_LOGIC_CLKBufTreeBot_UnitBuf_NMOS_NumberofGate=2,  # Number #-->check
				_LOGIC_CLKBufTreeBot_UnitBuf_NMOS_ChannelWidth=400,  # Number #-->check
				_LOGIC_CLKBufTreeBot_UnitBuf_NMOS_ChannelLength=30,  # Number #-->check
				## Pmos
				_LOGIC_CLKBufTreeBot_UnitBuf_PMOS_NumberofGate=2,  # Number #-->check
				_LOGIC_CLKBufTreeBot_UnitBuf_PMOS_ChannelWidth=800,  # Number #-->check
				_LOGIC_CLKBufTreeBot_UnitBuf_PMOS_ChannelLength=30,  # Number #-->check
				# Height
				_LOGIC_CLKBufTreeBot_UnitBuf_PMOSXvt2NMOSXvt=446,  # number #-->check
			## Clock Buffer Tree structure
			_LOGIC_CLKBufTreeBot_BufTree1and2_NumOfStage=4,  # len[Buf0, Buf1, ... ] 스테이지 수 (아래 버퍼 사이즈 리스트의 길이와 같아야 함.) #-->check
			_LOGIC_CLKBufTreeBot_BufTree1_SizeofEachStage=[1, 2, 4, 8],  # CompOutBuf: [Buf0, Buf1, Buf2 ...] #-->check
			_LOGIC_CLKBufTreeBot_BufTree2_SizeofEachStage=[1, 2, 4, 8],  # CLKDoutBuf: [Buf0, Buf1, Buf2 ...] #-->check
			_LOGIC_CLKBufTreeBot_XOffSet=0, #-->check

	## Clock Spine (Physical dimension)
		## CLK Source: upward, 1st floor
		_LOGIC_YWidthOfCLKSrc=100, #-->check
		## CLK Samp: upward, 2nd floor
		_LOGIC_SpaceBtwCLKSrcAndCLKSamp=100, #-->check
		_LOGIC_YWidthOfCLKSamp=100, #-->check
		## Comparator Output: downward, Basement1
		_LOGIC_YWidthOfCompOut=100, #-->check
		## CLK Dout: downward, basement2
		_LOGIC_SpaceBtwCompOutAndCLKDout=100, #-->check
		_LOGIC_YWidthOfCLKDout=100,#-->check

	## SetResetDFF
		## DFF Common
		_LOGIC_Test_distance=330, #-->check
		_LOGIC_DFF_PMOSXvt2NMOSXvt    = 1150, # number #-->check

		## Master Xgate1
			## Xgate common
			_LOGIC_Mst_Xgate1_XVT='SLVT', #-->check
			## Xgate NMOS
			_LOGIC_Mst_Xgate1_NMOS_NumberofGate=1, #-->check
			_LOGIC_Mst_Xgate1_NMOS_ChannelWidth=400, #-->check
			_LOGIC_Mst_Xgate1_NMOS_ChannelLength=30, #-->check
			## Xgate PMOS
			_LOGIC_Mst_Xgate1_PMOS_NumberofGate=1, #-->check
			_LOGIC_Mst_Xgate1_PMOS_ChannelWidth=800, #-->check
			_LOGIC_Mst_Xgate1_PMOS_ChannelLength=30, #-->check

		## Master Xgate2
			## Xgate common
			_LOGIC_Mst_Xgate2_XVT='SLVT', #-->check
			## Xgate NMOS
			_LOGIC_Mst_Xgate2_NMOS_NumberofGate           = 1, #-->check
			_LOGIC_Mst_Xgate2_NMOS_ChannelWidth           = 400,#-->check
			_LOGIC_Mst_Xgate2_NMOS_ChannelLength          = 30,#-->check
			## Xgate PMOS
			_LOGIC_Mst_Xgate2_PMOS_NumberofGate           = 1,#-->check
			_LOGIC_Mst_Xgate2_PMOS_ChannelWidth           = 800,#-->check
			_LOGIC_Mst_Xgate2_PMOS_ChannelLength          = 30,#-->check

		## Master Nor1
			## Nor1 common
			_LOGIC_Mst_Nor1_XVT='SLVT', #-->check
			## NMOS
				## NMOSA
				_LOGIC_Mst_Nor1_NMOSA_NumberofGate           = 4, #-->check
				_LOGIC_Mst_Nor1_NMOSA_ChannelWidth           = 400, #-->check
				_LOGIC_Mst_Nor1_NMOSA_ChannelLength          = 30,#-->check
				## NMOSB
				_LOGIC_Mst_Nor1_NMOSB_NumberofGate           = 4,#-->check
				_LOGIC_Mst_Nor1_NMOSB_ChannelWidth           = 400,#-->check
				_LOGIC_Mst_Nor1_NMOSB_ChannelLength          = 30,#-->check
			## PMOS
				## PMOSA
				_LOGIC_Mst_Nor1_PMOSA_NumberofGate            = 8,#-->check
				_LOGIC_Mst_Nor1_PMOSA_ChannelWidth            = 800,#-->check
				_LOGIC_Mst_Nor1_PMOSA_ChannelLength           = 30,#-->check
				## PMOSB
				_LOGIC_Mst_Nor1_PMOSB_NumberofGate            = 8,#-->check
				_LOGIC_Mst_Nor1_PMOSB_ChannelWidth            = 800,#-->check
				_LOGIC_Mst_Nor1_PMOSB_ChannelLength           = 30,#-->check

		## Master Nor2
			## Nor2 common
			_LOGIC_Mst_Nor2_XVT='SLVT', #-->check
			## NMOS
				## NMOSA
				_LOGIC_Mst_Nor2_NMOSA_NumberofGate           = 1,#-->check
				_LOGIC_Mst_Nor2_NMOSA_ChannelWidth           = 400,#-->check
				_LOGIC_Mst_Nor2_NMOSA_ChannelLength          = 30,#-->check
				## NMOSB
				_LOGIC_Mst_Nor2_NMOSB_NumberofGate           = 1,#-->check
				_LOGIC_Mst_Nor2_NMOSB_ChannelWidth           = 400,#-->check
				_LOGIC_Mst_Nor2_NMOSB_ChannelLength          = 30,#-->check
			## PMOS
				## PMOSA
				_LOGIC_Mst_Nor2_PMOSA_NumberofGate            = 2,#-->check
				_LOGIC_Mst_Nor2_PMOSA_ChannelWidth            = 800,#-->check
				_LOGIC_Mst_Nor2_PMOSA_ChannelLength           = 30,#-->check
				## PMOSB
				_LOGIC_Mst_Nor2_PMOSB_NumberofGate            = 3,#-->check
				_LOGIC_Mst_Nor2_PMOSB_ChannelWidth            = 800,#-->check
				_LOGIC_Mst_Nor2_PMOSB_ChannelLength           = 30,#-->check

		## Master Inv1 : Set pre-driver
			## Inv1 common
			_LOGIC_Mst_Inv1_XVT='SLVT', #-->check
			## Inv1 NMOS
			_LOGIC_Mst_Inv1_NMOS_NumberofGate           = 1, #-->check
			_LOGIC_Mst_Inv1_NMOS_ChannelWidth           = 400, #-->check
			_LOGIC_Mst_Inv1_NMOS_ChannelLength          = 30,#-->check
			## Inv1 PMOS
			_LOGIC_Mst_Inv1_PMOS_NumberofGate           = 1,#-->check
			_LOGIC_Mst_Inv1_PMOS_ChannelWidth           = 800,#-->check
			_LOGIC_Mst_Inv1_PMOS_ChannelLength          = 30,#-->check

		## Master Inv2 : Set driver
			## Inv2 common
			_LOGIC_Mst_Inv2_XVT='SLVT', #-->check
			## Inv2 NMOS
			_LOGIC_Mst_Inv2_NMOS_NumberofGate           = 3,#-->check
			_LOGIC_Mst_Inv2_NMOS_ChannelWidth           = 400,#-->check
			_LOGIC_Mst_Inv2_NMOS_ChannelLength          = 30,#-->check
			## Inv2 PMOS
			_LOGIC_Mst_Inv2_PMOS_NumberofGate           = 3,#-->check
			_LOGIC_Mst_Inv2_PMOS_ChannelWidth           = 800,#-->check
			_LOGIC_Mst_Inv2_PMOS_ChannelLength          = 30,#-->check

		## Master Inv3 : Clock driver
			## Inv3 common
			_LOGIC_Mst_Inv3_XVT='SLVT', #-->check
			## Inv3 NMOS
			_LOGIC_Mst_Inv3_NMOS_NumberofGate           = 2,#-->check
			_LOGIC_Mst_Inv3_NMOS_ChannelWidth           = 400,#-->check
			_LOGIC_Mst_Inv3_NMOS_ChannelLength          = 30,#-->check
			## Inv3 PMOS
			_LOGIC_Mst_Inv3_PMOS_NumberofGate           = 2,#-->check
			_LOGIC_Mst_Inv3_PMOS_ChannelWidth           = 800,#-->check
			_LOGIC_Mst_Inv3_PMOS_ChannelLength          = 30,#-->check

		## Slave Xgate1
			## Xgate common
			_LOGIC_Slv_Xgate1_XVT='SLVT',#-->check
			## Xgate NMOS
			_LOGIC_Slv_Xgate1_NMOS_NumberofGate           = 4,#-->check
			_LOGIC_Slv_Xgate1_NMOS_ChannelWidth           = 400,#-->check
			_LOGIC_Slv_Xgate1_NMOS_ChannelLength          = 30,#-->check
			## Xgate PMOS
			_LOGIC_Slv_Xgate1_PMOS_NumberofGate           = 4,#-->check
			_LOGIC_Slv_Xgate1_PMOS_ChannelWidth           = 800,#-->check
			_LOGIC_Slv_Xgate1_PMOS_ChannelLength          = 30,#-->check

		## Slave Xgate2
			## Xgate common
			_LOGIC_Slv_Xgate2_XVT='SLVT',#-->check
			## Xgate NMOS
			_LOGIC_Slv_Xgate2_NMOS_NumberofGate           = 4,#-->check
			_LOGIC_Slv_Xgate2_NMOS_ChannelWidth           = 400,#-->check
			_LOGIC_Slv_Xgate2_NMOS_ChannelLength          = 30,#-->check
			## Xgate PMOS
			_LOGIC_Slv_Xgate2_PMOS_NumberofGate           = 4,#-->check
			_LOGIC_Slv_Xgate2_PMOS_ChannelWidth           = 800,#-->check
			_LOGIC_Slv_Xgate2_PMOS_ChannelLength          = 30,#-->check

		## Slave Nor1
			## Nor1 common
			_LOGIC_Slv_Nor1_XVT='SLVT',#-->check
			## NMOS
				## NMOSA
				_LOGIC_Slv_Nor1_NMOSA_NumberofGate           = 4,#-->check
				_LOGIC_Slv_Nor1_NMOSA_ChannelWidth           = 400,#-->check
				_LOGIC_Slv_Nor1_NMOSA_ChannelLength          = 30,#-->check
				## NMOSB
				_LOGIC_Slv_Nor1_NMOSB_NumberofGate           = 4,#-->check
				_LOGIC_Slv_Nor1_NMOSB_ChannelWidth           = 400,#-->check
				_LOGIC_Slv_Nor1_NMOSB_ChannelLength          = 30,#-->check
			## PMOS
				## PMOSA
				_LOGIC_Slv_Nor1_PMOSA_NumberofGate            = 8,#-->check
				_LOGIC_Slv_Nor1_PMOSA_ChannelWidth            = 800,#-->check
				_LOGIC_Slv_Nor1_PMOSA_ChannelLength           = 30,#-->check
				## PMOSB
				_LOGIC_Slv_Nor1_PMOSB_NumberofGate            = 8,#-->check
				_LOGIC_Slv_Nor1_PMOSB_ChannelWidth            = 800,#-->check
				_LOGIC_Slv_Nor1_PMOSB_ChannelLength           = 30,#-->check

		## Slave Nor2
			## Nor2 common
			_LOGIC_Slv_Nor2_XVT='SLVT', #-->check
			## NMOS
				## NMOSA
				_LOGIC_Slv_Nor2_NMOSA_NumberofGate           = 2,#-->check
				_LOGIC_Slv_Nor2_NMOSA_ChannelWidth           = 400,#-->check
				_LOGIC_Slv_Nor2_NMOSA_ChannelLength          = 30,#-->check
				## NMOSB
				_LOGIC_Slv_Nor2_NMOSB_NumberofGate           = 2,#-->check
				_LOGIC_Slv_Nor2_NMOSB_ChannelWidth           = 400,#-->check
				_LOGIC_Slv_Nor2_NMOSB_ChannelLength          = 30,#-->check
			## PMOS
				## PMOSA
				_LOGIC_Slv_Nor2_PMOSA_NumberofGate            = 4,#-->check
				_LOGIC_Slv_Nor2_PMOSA_ChannelWidth            = 800,#-->check
				_LOGIC_Slv_Nor2_PMOSA_ChannelLength           = 30,#-->check
				## PMOSB
				_LOGIC_Slv_Nor2_PMOSB_NumberofGate            = 4,#-->check
				_LOGIC_Slv_Nor2_PMOSB_ChannelWidth            = 800,#-->check
				_LOGIC_Slv_Nor2_PMOSB_ChannelLength           = 30,#-->check

		## Slave Inv1 : ReSet pre-driver
			## Inv1 common
			_LOGIC_Slv_Inv1_XVT='SLVT',#-->check
			## Inv1 NMOS
			_LOGIC_Slv_Inv1_NMOS_NumberofGate           = 1,#-->check
			_LOGIC_Slv_Inv1_NMOS_ChannelWidth           = 400,#-->check
			_LOGIC_Slv_Inv1_NMOS_ChannelLength          = 30,#-->check
			## Inv1 PMOS
			_LOGIC_Slv_Inv1_PMOS_NumberofGate           = 1,#-->check
			_LOGIC_Slv_Inv1_PMOS_ChannelWidth           = 800,#-->check
			_LOGIC_Slv_Inv1_PMOS_ChannelLength          = 30,#-->check

		## Slave Inv2 : ReSet driver
			## Inv2 common
			_LOGIC_Slv_Inv2_XVT='SLVT',#-->check
			## Inv2 NMOS
			_LOGIC_Slv_Inv2_NMOS_NumberofGate           = 2,#-->check
			_LOGIC_Slv_Inv2_NMOS_ChannelWidth           = 400,#-->check
			_LOGIC_Slv_Inv2_NMOS_ChannelLength          = 30,#-->check
			## Inv2 PMOS
			_LOGIC_Slv_Inv2_PMOS_NumberofGate           = 2,#-->check
			_LOGIC_Slv_Inv2_PMOS_ChannelWidth           = 800,#-->check
			_LOGIC_Slv_Inv2_PMOS_ChannelLength          = 30,#-->check

		## Slave Inv3 : Qb driver
			## Inv3 common
			_LOGIC_Slv_Inv3_XVT='SLVT', #-->check
			## Inv3 NMOS
			_LOGIC_Slv_Inv3_NMOS_NumberofGate           = 4,#-->check
			_LOGIC_Slv_Inv3_NMOS_ChannelWidth           = 400,#-->check
			_LOGIC_Slv_Inv3_NMOS_ChannelLength          = 30,#-->check
			## Inv3 PMOS
			_LOGIC_Slv_Inv3_PMOS_NumberofGate           = 4,#-->check
			_LOGIC_Slv_Inv3_PMOS_ChannelWidth           = 800,#-->check
			_LOGIC_Slv_Inv3_PMOS_ChannelLength          = 30,#-->check
	## DAC PreDriver
		## Inverter Chain
			## InvChain Common
			_LOGIC_DACPreDrv_PMOSXvt2NMOSXvt=500,  # number #-->check
			## Inverter Chain
				## Inv1 common
			_LOGIC_DACPreDrv_NumberofGate=[[1,1,3,9],[1,1,3,9],[1,1,3,9],[1,1,3,9],[1,1,3,9],[1,1,3,9],    [1,1,3,9],[1,1,3,9],[1,1,3,9],[1,1,3,9]],  # Vector #-->check
			_RDAC_InputComple_Inv_NumofGate = [7,7,7,7], # Vector, _LOGIC_DACPreDrv_NumberofGate + _RDAC_InputComple_Inv_NumofGate로 입력됨  #-->check
			_LOGIC_DACPreDrv_ChannelLength=30,  # Scalar #-->check
			_LOGIC_DACPreDrv_XVT='SLVT',  # 'SLVT' #-->check
				## Inv1 NMOS
			_LOGIC_DACPreDrv_Inv_NMOS_ChannelWidth=400,  # Scalar #-->check
				## Inv1 PMOS
			_LOGIC_DACPreDrv_Inv_PMOS_ChannelWidth=800,  # Scalar #-->check
	## CLKOutSamp(!=ClkSamp)
		## Common
			# XVT
			_LOGIC_CLKoutSamp_XVT = 'SLVT', #-->check
		## Inverter
			# Nmos
			_LOGIC_CLKoutSamp_Inv_NMOS_NumberofGate=1,  # Number #-->check
			_LOGIC_CLKoutSamp_Inv_NMOS_ChannelWidth=400,  # Number #-->check
			_LOGIC_CLKoutSamp_Inv_NMOS_ChannelLength=30,  # Number #-->check
			# Pmos
			_LOGIC_CLKoutSamp_Inv_PMOS_NumberofGate=1,  # Number #-->check
			_LOGIC_CLKoutSamp_Inv_PMOS_ChannelWidth=800,  # Number #-->check
			_LOGIC_CLKoutSamp_Inv_PMOS_ChannelLength=30,  # Number #-->check
		## AND
			## AND Common
			## Nand
				# NmosA
				_LOGIC_CLKoutSamp_And_Nand_NMOSA_NumberofGate=2,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Nand_NMOSA_ChannelWidth=400,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Nand_NMOSA_ChannelLength=30,  # Number #-->check
				# NMOSB
				_LOGIC_CLKoutSamp_And_Nand_NMOSB_NumberofGate=2,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Nand_NMOSB_ChannelWidth=400,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Nand_NMOSB_ChannelLength=30,  # Number #-->check
				# PMOSA
				_LOGIC_CLKoutSamp_And_Nand_PMOSA_NumberofGate=1,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Nand_PMOSA_ChannelWidth=800,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Nand_PMOSA_ChannelLength=30,  # Number #-->check
				# PMOSB
				_LOGIC_CLKoutSamp_And_Nand_PMOSB_NumberofGate=1,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Nand_PMOSB_ChannelWidth=800,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Nand_PMOSB_ChannelLength=30,  # Number #-->check
			## Inverter
				# Nmos
				_LOGIC_CLKoutSamp_And_Inv_NMOS_NumberofGate=4,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Inv_NMOS_ChannelWidth=400,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Inv_NMOS_ChannelLength=30,  # Number #-->check
				# Pmos
				_LOGIC_CLKoutSamp_And_Inv_PMOS_NumberofGate=4,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Inv_PMOS_ChannelWidth=800,  # Number #-->check
				_LOGIC_CLKoutSamp_And_Inv_PMOS_ChannelLength=30,  # Number #-->check


## Comparator
	## StrongARM Latch
		# Common
		_COMP_SALatch_ChannelLength=30,  # random.randrange(30, 60, 2),  # 30  #-->check
		_COMP_SALatch_XVT='HVT',  #-->check

		# PMOS
		_COMP_SALatch_CLKinputPMOSFinger1=1,  #PMOS Reset Sw1 # random.randint(1, 15),  # 6  #-->check
		_COMP_SALatch_CLKinputPMOSFinger2=1,  #PMOS Reset Sw2 # random.randint(1, 15),  # 3  #-->check
		_COMP_SALatch_PMOSFinger=1,  		  #PMOS Latch	  # random.randint(1, 15),  # 3  #-->check
		_COMP_SALatch_PMOSChannelWidth=1000,  #All PMOS width # random.randrange(200, 1050, 2),  # 500  #-->check

		# NMOS
		_COMP_SALatch_DATAinputNMOSFinger=3,  #NMOS Input Tr # random.randint(3, 15),  # 12  #-->check
		_COMP_SALatch_NMOSFinger=2,  		  #NMOS at Latch # random.randint(1, 15),  # 2  #-->check
		_COMP_SALatch_CLKinputNMOSFinger=1,  #NMOS Tail # random.randint(1, 15),  # 8  #-->check
		_COMP_SALatch_NMOSChannelWidth=330,  #Nmos width # random.randrange(200, 1050, 2),  # 500  #-->check
		_COMP_SALatch_CLKinputNMOSChannelWidth=200,  # random.randrange(200, 1050, 2),  # 800  #-->check

	## StrongArmOutBuffer and SRLatch
		## Common
			# XVT
			_COMP_SAOutBufAndSRLatch_XVT='SLVT', #-->check
			# Body
			_COMP_SAOutBufAndSRLatch_NMOS_Pbody_XvtTop2Pbody=1250,  # Number/None(Minimum) #-->check (1250인데 None으로 해도 상관없을듯)
			_COMP_SAOutBufAndSRLatch_PMOS_Nbody_Xvtdown2Nbody=None,  # Number/None(Minimum) #-->check
			# Height
			_COMP_SAOutBufAndSRLatch_PMOSXvt2NMOSXvt=1000,  # number   #-->check
		## StronArm Output Buffer
			## Inverter1(pre)
					#Nmos
				_COMP_SAOutBuf_Buf_Inv1_NMOS_NumberofGate          = 1,        # Number #-->check
				_COMP_SAOutBuf_Buf_Inv1_NMOS_ChannelWidth          = 1000,      # Number #-->check
				_COMP_SAOutBuf_Buf_Inv1_NMOS_ChannelLength         = 30,       # Number #-->check
					#Pmos
				_COMP_SAOutBuf_Buf_Inv1_PMOS_NumberofGate          = 1,        # Number #-->check
				_COMP_SAOutBuf_Buf_Inv1_PMOS_ChannelWidth          = 2000,      # Number #-->check
				_COMP_SAOutBuf_Buf_Inv1_PMOS_ChannelLength         = 30,       # Number #-->check
			## Inverter2
					#Nmos
				_COMP_SAOutBuf_Buf_Inv2_NMOS_NumberofGate          = 1,        # Number  #-->check
				_COMP_SAOutBuf_Buf_Inv2_NMOS_ChannelWidth          = 1000,      # Number #-->check
				_COMP_SAOutBuf_Buf_Inv2_NMOS_ChannelLength         = 30,       # Number #-->check
					#Pmos
				_COMP_SAOutBuf_Buf_Inv2_PMOS_NumberofGate          = 1,        # Number #-->check
				_COMP_SAOutBuf_Buf_Inv2_PMOS_ChannelWidth          = 2000,      # Number #-->check
				_COMP_SAOutBuf_Buf_Inv2_PMOS_ChannelLength         = 30,       # Number #-->check
		## SRLatch
			## Nand(Set,Rst same)
				# NmosA
				_COMP_SRLatch_Nand_NMOSA_NumberofGate=2,  # Number #-->check
				_COMP_SRLatch_Nand_NMOSA_ChannelWidth=1000,  # Number #-->check
				_COMP_SRLatch_Nand_NMOSA_ChannelLength=30,  # Number #-->check
				# NMOSB
				_COMP_SRLatch_Nand_NMOSB_NumberofGate=2,  # Number #-->check
				_COMP_SRLatch_Nand_NMOSB_ChannelWidth=100,  # Number #-->check
				_COMP_SRLatch_Nand_NMOSB_ChannelLength=30,  # Number #-->check
				# PMOSA
				_COMP_SRLatch_Nand_PMOSA_NumberofGate=1,  # Number #-->check
				_COMP_SRLatch_Nand_PMOSA_ChannelWidth=2000,  # Number #-->check
				_COMP_SRLatch_Nand_PMOSA_ChannelLength=30,  # Number #-->check
				# PMOSB
				_COMP_SRLatch_Nand_PMOSB_NumberofGate=1,  # Number #-->check
				_COMP_SRLatch_Nand_PMOSB_ChannelWidth=2000,  # Number #-->check
				_COMP_SRLatch_Nand_PMOSB_ChannelLength=30,  # Number #-->check

	## Comp clock Gen Logic: Clk_Samp Inv, Clk_Source Inv, AND Gate, CompClockBuff
		## Common
			# XVT
			_COMP_CompClkLogic_XVT='SLVT',  #-->check
			# Body
			_COMP_CompClkLogic_NMOS_Pbody_XvtTop2Pbody=600,  # Number/None(Minimum) #-->check (None으로 해도 될듯)
			_COMP_CompClkLogic_PMOS_Nbody_Xvtdown2Nbody=None,  # Number/None(Minimum)  #-->check
			# Height
			_COMP_CompClkLogic_PMOSXvt2NMOSXvt=1000,  # number  #-->check
		## StronArm Output Buffer
			## Inverter1(pre)
					#Nmos
				_COMP_CompClkLogic_Buf_Inv1_NMOS_NumberofGate          = 2,        # Number #-->check
				_COMP_CompClkLogic_Buf_Inv1_NMOS_ChannelWidth          = 400,      # Number #-->check
				_COMP_CompClkLogic_Buf_Inv1_NMOS_ChannelLength         = 30,       # Number #-->check
					#Pmos
				_COMP_CompClkLogic_Buf_Inv1_PMOS_NumberofGate          = 2,        # Number #-->check
				_COMP_CompClkLogic_Buf_Inv1_PMOS_ChannelWidth          = 800,      # Number #-->check
				_COMP_CompClkLogic_Buf_Inv1_PMOS_ChannelLength         = 30,       # Number #-->check
			## Inverter2
					#Nmos
				_COMP_CompClkLogic_Buf_Inv2_NMOS_NumberofGate          = 4,        # Number #-->check
				_COMP_CompClkLogic_Buf_Inv2_NMOS_ChannelWidth          = 400,      # Number #-->check
				_COMP_CompClkLogic_Buf_Inv2_NMOS_ChannelLength         = 30,       # Number #-->check
					#Pmos
				_COMP_CompClkLogic_Buf_Inv2_PMOS_NumberofGate          = 4,        # Number #-->check
				_COMP_CompClkLogic_Buf_Inv2_PMOS_ChannelWidth          = 800,      # Number #-->check
				_COMP_CompClkLogic_Buf_Inv2_PMOS_ChannelLength         = 30,       # Number #-->check
		## AND
			## Nand
				# NmosA
				_COMP_CompClkLogic_Nand_NMOSA_NumberofGate=2,  # Number #-->check
				_COMP_CompClkLogic_Nand_NMOSA_ChannelWidth=400,  # Number #-->check
				_COMP_CompClkLogic_Nand_NMOSA_ChannelLength=30,  # Number #-->check
				# NMOSB
				_COMP_CompClkLogic_Nand_NMOSB_NumberofGate=2,  # Number #-->check
				_COMP_CompClkLogic_Nand_NMOSB_ChannelWidth=400,  # Number #-->check
				_COMP_CompClkLogic_Nand_NMOSB_ChannelLength=30,  # Number #-->check
				# PMOSA
				_COMP_CompClkLogic_Nand_PMOSA_NumberofGate=1,  # Number #-->check
				_COMP_CompClkLogic_Nand_PMOSA_ChannelWidth=800,  # Number #-->check
				_COMP_CompClkLogic_Nand_PMOSA_ChannelLength=30,  # Number #-->check
				# PMOSB
				_COMP_CompClkLogic_Nand_PMOSB_NumberofGate=1,  # Number #-->check
				_COMP_CompClkLogic_Nand_PMOSB_ChannelWidth=800,  # Number #-->check
				_COMP_CompClkLogic_Nand_PMOSB_ChannelLength=30,  # Number #-->check
			## Inverter
				# Nmos
				_COMP_CompClkLogic_Inv_NMOS_NumberofGate=1,  # Number #-->check
				_COMP_CompClkLogic_Inv_NMOS_ChannelWidth=400,  # Number #-->check
				_COMP_CompClkLogic_Inv_NMOS_ChannelLength=30,  # Number #-->check
				# Pmos
				_COMP_CompClkLogic_Inv_PMOS_NumberofGate=1,  # Number #-->check
				_COMP_CompClkLogic_Inv_PMOS_ChannelWidth=800,  # Number #-->check
				_COMP_CompClkLogic_Inv_PMOS_ChannelLength=30,  # Number #-->check

		## Clk_Source Inv
				#Nmos
			_COMP_CompClkLogic_ClkSrc_NMOS_NumberofGate          = 1,        # Number #-->check
			_COMP_CompClkLogic_ClkSrc_NMOS_ChannelWidth          = 400,      # Number #-->check
			_COMP_CompClkLogic_ClkSrc_NMOS_ChannelLength         = 30,       # Number #-->check
				#Pmos
			_COMP_CompClkLogic_ClkSrc_PMOS_NumberofGate          = 1,        # Number #-->check
			_COMP_CompClkLogic_ClkSrc_PMOS_ChannelWidth          = 800,      # Number #-->check
			_COMP_CompClkLogic_ClkSrc_PMOS_ChannelLength         = 30,       # Number #-->check
		## Clk_Samp Inv
				#Nmos
			_COMP_CompClkLogic_ClkSmp_NMOS_NumberofGate          = 1,        # Number #-->check
			_COMP_CompClkLogic_ClkSmp_NMOS_ChannelWidth          = 400,      # Number #-->check
			_COMP_CompClkLogic_ClkSmp_NMOS_ChannelLength         = 30,       # Number #-->check
				#Pmos
			_COMP_CompClkLogic_ClkSmp_PMOS_NumberofGate          = 1,        # Number #-->check
			_COMP_CompClkLogic_ClkSmp_PMOS_ChannelWidth          = 800,      # Number #-->check
			_COMP_CompClkLogic_ClkSmp_PMOS_ChannelLength         = 30,       # Number #-->check
...
## CLOCK AND DATA BUF : Comparator Dout Buf for driving Logic, CLKSamp and CLKScr Buff for Driving Sampler and Comparator
	## Top placed
		## CLK Samp
			## InvChain Common
				## Height
		_BUF_CLKSamp_PMOSXvt2NMOSXvt = 500,  # number #-->check
			## Inverter Chain
				## Inv1 common
		_BUF_CLKSamp_XVT='SLVT', #-->check
		_BUF_CLKSamp_NumberofGate = [2,4,8,16],  # Vector, #-->check
		_BUF_CLKSamp_ChanneLength = 30, #-->check
				## NMOS
		_BUF_CLKSamp_NMOSChannelWidth = 400, #-->check
				## PMOS
		_BUF_CLKSamp_PMOSChannelWidth = 800, #-->check
		## CLK Scr
			## InvChain Common
				## Height
		_BUF_CLKScr_PMOSXvt2NMOSXvt = 500,  # number #-->check
			## Inverter Chain
				## Inv1 common
		_BUF_CLKScr_XVT='SLVT', #-->check
		_BUF_CLKScr_NumberofGate = [1,2,4,8],  # Vector, #-->check
		_BUF_CLKScr_ChanneLength = 30, #-->check
				## NMOS
		_BUF_CLKScr_NMOSChannelWidth = 400, #-->check
				## PMOS
		_BUF_CLKScr_PMOSChannelWidth = 800, #-->check
	## Bottom Placed
		## CompOut
			## InvChain Common
				## Height
		_BUF_CompOut_PMOSXvt2NMOSXvt = 500,  # number #-->check
			## Inverter Chain
				## Inv1 common
		_BUF_CompOut_XVT='SLVT', #-->check
		_BUF_CompOut_NumberofGate = [2,4],  # Vector, #-->check
		_BUF_CompOut_ChanneLength = 30, #-->check
				## NMOS
		_BUF_CompOut_NMOSChannelWidth = 400, #-->check
				## PMOS
		_BUF_CompOut_PMOSChannelWidth = 800, #-->check



## CDAC
	## CDAC Configuration
	_CDAC_FoldingTF = False, #True/False  #-->check
	_CDACDrv_ArrangedTF = False, #True= Arranged, False=CommonCent  #-->check
	## CDAC Drv
		## Unit DRv
			## Common
				# XVT
			_CDACDrv_XVT = 'SLVT',  #-->check
			## NMOS
			_CDACDrv_NMOS_NumberofGate=1,  # Number  #-->check
			_CDACDrv_NMOS_ChannelWidth = 400, #Number #-->check
			_CDACDrv_NMOS_ChannelLength = 30, #Number #-->check
			## PMOS
			_CDACDrv_PMOS_NumberofGate=1,  # Number #-->check
			_CDACDrv_PMOS_ChannelWidth = 800, #Number #-->check
			_CDACDrv_PMOS_ChannelLength = 30, #Number #-->check
		## Option(Arragned Only, _CDACDrv_ArrangedTF = 'True')
		_CDACDrv_DesignatedEachSize = [8,4,3,3], # Vector, designates each driver size(multiples of Unit Drv size) #-->No use
	## CDAC
			## Element CDAC
			_CDAC_LayoutOption=[5,6],  # Vector, Consecutive Number [3,4,5] #-->check
			_CDAC_MetalWidth=50,  # Number #-->check
			_CDAC_MetalLength=2920,  # Number (8bit size: 1414/ 10bit size: 2800/ 12bit size: 4200) #-->check
			_CDAC_MetalSpacing=50,  # Number #-->check

			## Unit Cap
			_CDAC_NumOfElement=4,  # Number #-->check

			## Shield
			_CDAC_ShieldingLayer=1,  # Poly:0, M1:1, M2:2 ... #-->check
			_CDAC_ConnectLength=400,  # Number #-->check
			_CDAC_ExtendLength=400,  # Number #-->check

			## Dummy Cap Option
			_CDAC_NumOfDummyCaps=10,  # Number, Number of dummy cap(one side)  #-->check
			_CDAC_DummyCap_TopBottomShort=None,  # True => Top - Bottom Short, False -> Bottom = GND, None => Floating Bottom Node  #-->check

			## CommonCentroid With Driving node
			_CDAC_CapArrayWDrivingNodeDistance=2000,  # Number   #-->check
			_CDAC_DriveNodeDistance=279,  # Number  #-->check
			_CDAC_YWidth_Bottom_Hrz=50,  # Number  #-->check
			_CDAC_BotNodeVtcExtensionMetalLayer=2,  #-->check
...
## Bootstrapped Switch
	# Input/Output node
		# INPUT node
		_Sampler_Inputnode_width = 600,  # number #-->check
		# OUTPUT node
		_Sampler_Outputnode_width = 600,  # number #-->check
	# TR1
		_Sampler_Tr1_NumberofGate	            = 2,       # Number #-->check
		_Sampler_Tr1_ChannelWidth	            = 300,     # Number #-->check
		_Sampler_Tr1_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr1_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR2
		_Sampler_Tr2_NumberofGate	            = 1,       # Number #-->check
		_Sampler_Tr2_ChannelWidth	            = 1000,     # Number #-->check
		_Sampler_Tr2_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr2_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR4
		_Sampler_Tr4_NumberofGate	            = 2,       # Number #-->check
		_Sampler_Tr4_ChannelWidth	            = 500,     # Number #-->check
		_Sampler_Tr4_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr4_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR5
		_Sampler_Tr5_NumberofGate	            = 1,       # Number #-->check
		_Sampler_Tr5_ChannelWidth	            = 1000,     # Number #-->check
		_Sampler_Tr5_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr5_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR7
		_Sampler_Tr7_NumberofGate               = 1,  # Number #-->check
		_Sampler_Tr7_ChannelWidth	            = 1000,     # Number #-->check
		_Sampler_Tr7_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr7_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR9
		_Sampler_Tr9_NumberofGate               = 2,  # Number #-->check
		_Sampler_Tr9_ChannelWidth	            = 1000,     # Number #-->check
		_Sampler_Tr9_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr9_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR8
		_Sampler_Tr8_NumberofGate	            = 2,       # Number #-->check
		_Sampler_Tr8_ChannelWidth	            = 500,     # Number #-->check
		_Sampler_Tr8_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr8_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR6
		_Sampler_Tr6_NumberofGate	            = 1,       # Number #-->check
		_Sampler_Tr6_ChannelWidth	            = 1000,     # Number #-->check
		_Sampler_Tr6_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr6_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR11
		_Sampler_Tr11_NumberofGate	            = 2,       # Number #-->check
		_Sampler_Tr11_ChannelWidth	            = 1000,     # Number #-->check
		_Sampler_Tr11_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr11_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# Tie4N
		_Sampler_Tie4N_NumberofGate     	    = 4,       # Number #-->check
		_Sampler_Tie4N_ChannelWidth	            = 250,     # Number #-->check
		_Sampler_Tie4N_ChannelLength	        = 30,       # Number #-->check
		_Sampler_Tie4N_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# Tie4P
		_Sampler_Tie4P_NumberofGate	            = 4,       # Number #-->check
		_Sampler_Tie4P_ChannelWidth	            = 500,     # Number #-->check
		_Sampler_Tie4P_ChannelLength	        = 30,       # Number #-->check
		_Sampler_Tie4P_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# Tie8N
		_Sampler_Tie8N_NumberofGate	            = 4,       # Number #-->check
		_Sampler_Tie8N_ChannelWidth	            = 250,     # Number #-->check
		_Sampler_Tie8N_ChannelLength	        = 30,       # Number #-->check
		_Sampler_Tie8N_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# Tie8P
		_Sampler_Tie8P_NumberofGate	            = 4,       # Number #-->check
		_Sampler_Tie8P_ChannelWidth	            = 500,     # Number #-->check
		_Sampler_Tie8P_ChannelLength	        = 30,       # Number #-->check
		_Sampler_Tie8P_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR12
		_Sampler_Tr12_NumberofGate	            = 1,       # Number #-->check
		_Sampler_Tr12_ChannelWidth	            = 1000,     # Number #-->check
		_Sampler_Tr12_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr12_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR3
		_Sampler_Tr3_NumberofGate	            = 1,       # Number #-->check
		_Sampler_Tr3_ChannelWidth	            = 1000,     # Number #-->check
		_Sampler_Tr3_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr3_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check
	# TR10
		_Sampler_Tr10_NumberofGate	            = 1,       # Number #-->check
		_Sampler_Tr10_ChannelWidth	            = 1000,     # Number #-->check
		_Sampler_Tr10_ChannelLength	            = 30,       # Number #-->check
		_Sampler_Tr10_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT #-->check

	# HDVNCAP (200x3 = 601fF)
		_Sampler_HDVNCAP_Length = 6000, #-->check
		_Sampler_HDVNCAP_LayoutOption = [3,4,5,6], # Writedown [number1, number2, number3, ...] #-->check
		_Sampler_HDVNCAP_NumFigPair = 53, #number (ref:75) #-->check

		_Sampler_HDVNCAP_Array = 3, #number: 1xnumber #-->check
		_Sampler_HDVNCAP_Cbot_Ctop_metalwidth = 1000, #number #-->check

	# CLKBGen Inverter
		#Common
		_Sampler_ClkbGenInv_XVT                        = 'SLVT', #-->check
		#Nmos
		_Sampler_ClkbGenInv_NMOS_NumberofGate          = 16,        # Number #-->check
		_Sampler_ClkbGenInv_NMOS_ChannelWidth          = 400,      # Number #-->check
		_Sampler_ClkbGenInv_NMOS_ChannelLength         = 30,       # Number #-->check
		#Pmos
		_Sampler_ClkbGenInv_PMOS_NumberofGate          = 16,        # Number #-->check
		_Sampler_ClkbGenInv_PMOS_ChannelWidth          = 800,      # Number #-->check
		_Sampler_ClkbGenInv_PMOS_ChannelLength         = 30,       # Number #-->check
		#Body
		_Sampler_ClkbGenInv_NMOS_Pbody_XvtTop2Pbody    = None,     # Number/None(Minimum) #-->check
		_Sampler_ClkbGenInv_PMOS_Nbody_Xvtdown2Nbody   = None,     # Number/None(Minimum) #-->check
		#Height
		_Sampler_ClkbGenInv_PMOSXvt2NMOSXvt            = 500,     # number #-->check


#RDAC and Decoder
	#RDAC and Decoder delta X displacement for DRC
	_RDAC_displacement = +11000, #-->check
	#RDAC and Decoder Size : Consider "_Decoder_RBit" and "_Unit_Num_EachStag_input" ex) [2, 8] --> 4 : 2*8 = 2**4
	_RDAC_Size = [1,16], #-->check
	#ResArray
		#Unit Resistor
		_RDAC_Array_ResWidth	=	400, #-->check
		_RDAC_Array_ResLength	=	2514, #-->check

	## Decoder
		## Array
			# _Unit to Unit distance for DRC of routing
			_RDAC_Decoder_Unit2UnitDist=400,  # number must be 100의 배수  #-->check
		# Unit
			## Comoon
				# Routing
				_RDAC_Decoder_Unit_Routing_Dist=50,  #-->check
				# Xvt
				_RDAC_Decoder_Unit_Xvt='SLVT',  #-->check
				# Dist
				_RDAC_Decoder_Unit_GatetoGateDist = 150,  #-->check
				# Inputs of Nand,Nor
				_RDAC_Decoder_Unit_Num_EachStag_input = [4], # ex) [2,3,4] 가장 마지막단(TG driving) nand input4, Nor input3, Nand input2, Nor input2 ... #-->check
				# Power rail
					# Pbody_Pulldown(NMOS)
					_RDAC_Decoder_Unit_Pbody_XvtTop2Pbody    = None,  # Number/None(Minimum) #-->check
					# Nbody_Pullup(PMOS)
					_RDAC_Decoder_Unit_Nbody_Xvtdown2Nbody   = None,  # Number/None(Minimum) #-->check
					# PMOS and NMOS Height
					_RDAC_Decoder_Unit_PMOSXvt2NMOSXvt       = 1000,  # number #-->check
			# Nand( _Decoder_Unit_Num_EachStag_input에서 1,3,5,7...번째 해당하는 nand 생성)
				# MOSFET
					# Common
					_RDAC_Decoder_Nand_NumberofGate      = [2],  # Number #-->check
					_RDAC_Decoder_Nand_ChannelLength     = [30],  # Number #-->check
					# Pulldown(NMOS)
						_RDAC_Decoder_Nand_NMOS_ChannelWidth                 = [800],  # Number #-->check
					# Pulldown(PMOS)
						_RDAC_Decoder_Nand_PMOS_ChannelWidth                 = [400],  # Number #-->check
			# Nor( _Decoder_Unit_Num_EachStag_input에서 2,4,6,7...번째 해당하는 nor 생성)
				# MOSFET
					# Common
					_RDAC_Decoder_Nor_NumberofGate=[2, 7],  # Number  #-->no use
					_RDAC_Decoder_Nor_ChannelLength      = [30,30],  # Number #-->no use
					# Pulldown(NMOS)
						_RDAC_Decoder_Nor_NMOS_ChannelWidth	= [400,800],      # Number #-->no use
					# Pulldown(PMOS)
						_RDAC_Decoder_Nor_PMOS_ChannelWidth	= [800,1600],      # Number #-->no use
			# Inv
				#Common
				_RDAC_Decoder_Inv_NumberofGate   = 1, #-->check
				_RDAC_Decoder_Inv_ChannelLength  = 30, #-->check
				# NMosfet
					_RDAC_Decoder_Inv_NMOS_ChannelWidth	= 400,      # Number #-->check
				# PMosfet
					_RDAC_Decoder_Inv_PMOS_ChannelWidth  = 800,      # Number #-->check
			# Xgate
				# Common
				_RDAC_Decoder_Xgate_NumberofGate     = 1, #-->check
				_RDAC_Decoder_Xgate_ChannelLength    = 30, #-->check
				# NMosfet
					_RDAC_Decoder_Xgate_NMOS_ChannelWidth    = 400,      # Number #-->check
				# PMosfet
					_RDAC_Decoder_Xgate_PMOS_ChannelWidth    = 800,      # Number #-->check
	...
	with open('LayoutObj_ADC2024_RCDACSAR.pkl', 'wb') as f:
