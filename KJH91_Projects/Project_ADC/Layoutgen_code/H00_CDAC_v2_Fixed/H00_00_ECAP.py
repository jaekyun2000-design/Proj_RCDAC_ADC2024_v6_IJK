...
class _ECAP(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        for i in range(2):
            ...
            self._DesignParameter['SRF_Top_ViaM{}M{}'.format(TopMetalList[0],7)] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,_Name='{}:SRF_Top_ViaM{}M{}'.format(_Name,TopMetalList[0],7)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_H00_00_ECAP_Fixed'
