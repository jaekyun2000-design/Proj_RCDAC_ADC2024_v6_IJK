...
from KJH91_Projects.Project_ADC.Layoutgen_code.H00_CDAC_v2_Fixed import H00_01_UCAP
...
class _CapWithShield(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Via Gen: Extended node via
        ...
        self._DesignParameter['SRF_Shield_ViaM{}M{}'.format(_ShieldingLayer,7)] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,_Name='{}:SRF_Shield_ViaM{}M{}'.format(_Name,_ShieldingLayer,7)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_H00_02_CapWidthShield_Fixed'
    ...
    InputParams = dict(
        # # Unit CDAC
        _LayoutOption=[2,3],        # Poly:0, M1:1, M2:2 ...
        _ShieldingLayer=1,
        _MetalWidth=50,
        _MetalLength=1414,
        _MetalSpacing=50,
