...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_H00_03_DummyCapUnit_Fixed'
    cellname = 'H00_00_DummyCapUnit_99'
    _fileName = cellname + '.gds'

    ''' Input Parameters for Layout Object ''' ############################################################### ^^^^^^^^^^^^^^^^^^^^^
    InputParams = dict(
        # # Unit CDAC
        _LayoutOption=[3],        # Poly:0, M1:1, M2:2 ...
        _ShieldingLayer=1,
        _MetalWidth=50,
        _MetalLength=1414,
        _MetalSpacing=50,
        ...
        # Dummy Cap Option: True/False/None
        _DummyCap_TopBottomShort=False
     )
