...
from KJH91_Projects.Project_ADC.Layoutgen_code.H03_CDACWtDriver_Fold_CommonCent_Fixed import H03_01_CDACWtDriver_UnFold_CommonCent
from KJH91_Projects.Project_ADC.Layoutgen_code.H03_CDACWtDriver_Fold_CommonCent_Fixed import H03_01_CDACWtDriver_Fold_CommonCent
from KJH91_Projects.Project_ADC.Layoutgen_code.H04_CDACWtDriver_Fold_Arranged_Fixed import H04_01_CDACWtDriver_Fold_Arrange
from KJH91_Projects.Project_ADC.Layoutgen_code.H05_CDACWtDriver_Unfold_Arranged_Fixed import H05_01_CDACWtDriver_UnFold_Arrange
...
## CDAC
    ...
    _CDACDrv_ArrangedTF = 'True', #True= Arranged, False=CommonCent
    ## CDAC Drv
        ## Unit DRv
            ## Common
                # XVT
    ...
    ## CDAC
        ...
        if _CDAC_FoldingTF == True:
            if _CDACDrv_ArrangedTF == True:
                ################################################################################################################### CDAC:Fold, Drv:Arranged
                ## CDACWDriver (SREF) Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
                _Caculation_Parameters0 = copy.deepcopy(H04_01_CDACWtDriver_Fold_Arrange._CDACWtDriver._ParametersForDesignCalculation)
                ...
                self._DesignParameter['SRF_CDACWtDriver'] = self._SrefElementDeclaration(_DesignObj=H04_01_CDACWtDriver_Fold_Arrange._CDACWtDriver(_DesignParameter=None, _Name='{}:SRF_CDACWtDriver'.format(_Name)))[0]
                ...
                ################################################################################################################### CDAC:Fold, Drv:CommonCentro
                ## CDACWDriver (SREF) Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
                _Caculation_Parameters0 = copy.deepcopy(H03_01_CDACWtDriver_Fold_CommonCent._CDACWtDriver._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
                _Caculation_Parameters0['_NumOfBits'] = _NumOfBits
                ## CDAC
                ## CDAC Drv
                ...
                #############
                ## Upper CDAC (Cap, Driver Array) Generation
                self._DesignParameter['SRF_CDACWtDriver'] = self._SrefElementDeclaration(_DesignObj=H03_01_CDACWtDriver_Fold_CommonCent._CDACWtDriver(_DesignParameter=None, _Name='{}:SRF_CDACWtDriver'.format(_Name)))[0]
            ...
            if _CDACDrv_ArrangedTF == True:
                ################################################################################################################### CDAC:Unfold, Drv:Arranged
                ## CDACWDriver (SREF) Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
                _Caculation_Parameters0 = copy.deepcopy(H05_01_CDACWtDriver_UnFold_Arrange._CDACWtDriver._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
                _Caculation_Parameters0['_NumOfBits'] = _NumOfBits
                ## CDAC
                ## CDAC Drv
                ...
                #############
                ## Upper CDAC (Cap, Driver Array) Generation
                self._DesignParameter['SRF_CDACWtDriver'] = self._SrefElementDeclaration(_DesignObj=H05_01_CDACWtDriver_UnFold_Arrange._CDACWtDriver(_DesignParameter=None, _Name='{}:SRF_CDACWtDriver'.format(_Name)))[0]
                ...
                ################################################################################################################### CDAC:Unfold, Drv:CommonCenter
                ## CDACWDriver (SREF) Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
                _Caculation_Parameters0 = copy.deepcopy(H03_01_CDACWtDriver_UnFold_CommonCent._CDACWtDriver._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
                _Caculation_Parameters0['_NumOfBits'] = _NumOfBits
                ## CDAC
                ## CDAC Drv
                ...
                #############
                ## Upper CDAC (Cap, Driver Array) Generation
                self._DesignParameter['SRF_CDACWtDriver'] = self._SrefElementDeclaration(_DesignObj=H03_01_CDACWtDriver_UnFold_CommonCent._CDACWtDriver(_DesignParameter=None, _Name='{}:SRF_CDACWtDriver'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_H06_00_CDACWtDriver'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'H06_00_CDACWtDriver'
