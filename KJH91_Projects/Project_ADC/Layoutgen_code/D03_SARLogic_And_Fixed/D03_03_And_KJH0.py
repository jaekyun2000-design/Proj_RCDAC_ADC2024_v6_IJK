...
from KJH91_Projects.Project_ADC.Layoutgen_code.D03_SARLogic_And_Fixed import D03_02_Nand_KJH0
...
## AND
    ...
    ## Nand
        ...
        # PMOSA
        _Nand_PMOSA_NumberofGate=2,  # Number
        _Nand_PMOSA_ChannelWidth=100,  # Number
        ...
        # Body
        _Nand_NMOSAB_Pbody_XvtTop2Pbody=None,  # Number/None(Minimum)
        _Nand_PMOSAB_Nbody_Xvtdown2Nbody=None,  # Number/None(Minimum)
    ## Inverter
        # Nmos
        ...
        _Inv_PMOS_ChannelWidth=100,  # Number
        _Inv_PMOS_ChannelLength=30,  # Number
        # Body
        _Inv_NMOS_Pbody_XvtTop2Pbody=None,  # Number/None(Minimum)
        _Inv_PMOS_Nbody_Xvtdown2Nbody=None,  # Number/None(Minimum)
    )
...
## Inverter
    ...
    _Inv_PMOS_Nbody_Xvtdown2Nbody=None,  # Number/None(Minimum)
        ...
        _Calculation_Parameters = copy.deepcopy(D03_02_Nand_KJH0._Nand._ParametersForDesignCalculation)
        ...
        _Calculation_Parameters['_NMOSAB_Pbody_XvtTop2Pbody'] = _Nand_NMOSAB_Pbody_XvtTop2Pbody
        _Calculation_Parameters['_PMOSAB_Nbody_Xvtdown2Nbody'] = _Nand_PMOSAB_Nbody_Xvtdown2Nbody

        _Calculation_Parameters['_PMOSXvt2NMOSXvt'] = _And_PMOSXvt2NMOSXvt

                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_NAND'] = self._SrefElementDeclaration(_DesignObj=D03_02_Nand_KJH0._Nand(_DesignParameter=None, _Name='{}:SRF_NAND'.format(_Name)))[0]
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Inv SREF Generation
        _Calculation_Parameters = copy.deepcopy(D00_00_Inverter_KJH._Inverter._ParametersForDesignCalculation)
        ...
        _Calculation_Parameters['_NMOS_Pbody_XvtTop2Pbody'] = _Inv_NMOS_Pbody_XvtTop2Pbody
        _Calculation_Parameters['_PMOS_Nbody_Xvtdown2Nbody'] = _Inv_PMOS_Nbody_Xvtdown2Nbody

        _Calculation_Parameters['_PMOSXvt2NMOSXvt'] = _And_PMOSXvt2NMOSXvt

                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Inverter'] = self._SrefElementDeclaration(_DesignObj=D00_00_Inverter_KJH._Inverter(_DesignParameter=None, _Name='{}:SRF_Inverter'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_D03_03_And_Fixed'
