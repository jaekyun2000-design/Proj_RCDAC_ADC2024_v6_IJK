...
from KJH91_Projects.Project_ADC.Layoutgen_code.K00_SARLogicWtBuffers_RCHybrid               import K00_01_SARLogicWtCLKBufTree
from KJH91_Projects.Project_ADC.Layoutgen_code.J00_CDACPreDriver_InvBuffer_KJH0_RCHybrid    import J00_02_CDAC_PreDriver_KJH
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ00_RcdacSar_K00_02_SARLogicWtCDACPreDriver_YJH'
    ...
    InputParams = dict(
        ...
        ## Inverter Chain
        ## Inv1 common
        _CDACPreDriver_NumberofGate=[[1, 4, 16, 64],[1, 4, 16, 64,1],[1, 4, 16, 64,1]],  # Vector
        _CDACPreDriver_ChannelLength=30,  # Scalar
        _CDACPreDriver_XVT='SLVT',  # 'SLVT'
