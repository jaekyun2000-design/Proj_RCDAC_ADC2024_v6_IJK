...
class _CDACWtDriverFold1(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        ## CALCULATION START
        CDACWtDriver_Fold1_CC_start_time = time.time()
        ...
        self._DesignParameter['SRF_CDAC_LowerHalf'] = self._SrefElementDeclaration(_DesignObj=H02_00_CDACWtDriver._CDACWtDriver(_DesignParameter=None,_Name='{}:SRF_CDAC_LowerHalf'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_CDAC_UpperHalf'] = self._SrefElementDeclaration(_DesignObj=H02_00_CDACWtDriver._CDACWtDriver(_DesignParameter=None,_Name='{}:SRF_CDAC_UpperHalf'.format(_Name)))[0]
        ...
        print('##############################################')
        CDACWtDriver_Fold1_CC_end_time = time.time()
        self.CDACWtDriver_Fold1_CC_elapsed_time = CDACWtDriver_Fold1_CC_end_time - CDACWtDriver_Fold1_CC_start_time
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ00_RcdacSar_H02_01_CDACWtDriver_Fold1_CC'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'H02_00_CDACWDriver_Fold1_CC'
    ...
    InputParams = dict(
        ...
        ## CDAC and CDAC Driver
            ...
            ## CDAC
                # MOM Element of CDAC
        _CDAC_LayoutOption=[3,4],               # MOM cap으로 사용되는 Metal Layer
        ...
        _CDAC_MetalLength=1414,                 # MOM cap의 Length # (8bit size: 1414/ 10bit size: 2800/ 12bit size: 4200)
        ...
        _CDAC_DriveNodeDistance=279,            # Hrz M3와 Driver 사이 거리
