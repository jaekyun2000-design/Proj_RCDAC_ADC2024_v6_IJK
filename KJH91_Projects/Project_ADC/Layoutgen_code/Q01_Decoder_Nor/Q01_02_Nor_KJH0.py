...
from KJH91_Projects.Project_ADC.Layoutgen_code.Q01_Decoder_Nor import Q01_00_Pulldown_KJH0
from KJH91_Projects.Project_ADC.Layoutgen_code.Q01_Decoder_Nor import Q01_01_Pullup_KJH0
...
class _Nor(StickDiagram_KJH1._StickDiagram_KJH):
	...
	_ParametersForDesignCalculation = dict(
		...
		# Num of Input
		_Nor_Num_Input=3,  # Number>2
		
		# MOSFET
		# Common
		_Nor_ChannelLength=30,  # Number
		_Nor_POGate_ViaMxMx=[0, 1],  # Ex) [1,5] -> ViaM1M5
		_Nor_XVT	= 'SLVT'  ,   # 'XVT' ex)SLVT/LVT/RVT/HVT
		# Pulldown(NMOS)
		# Physical dimension
		_Nor_NMOS_ChannelWidth	= 350,      # Number  _Nor_NMOS_NumberofGate                  = 3,# Poly Gate setting
		# Poly Gate setting : vertical length
		_Nor_NMOS_POGate_Comb_length            = None,      # None/Number
		# Pulldown(PMOS)
		# Physical dimension
		_Nor_PMOS_ChannelWidth	                = 350,      # Number
		_Nor_PMOS_NumberofGate                  = 12,
		# Source_node setting
		_Nor_PMOS_Source_Via_Close2POpin_TF     =False,  # True/False --> First MOS
		# Poly Gate setting
		# Poly Gate setting : vertical length
		_Nor_PMOS_POGate_Comb_length            = None,      # None/Number
		
		# Power Rail
		# Pbody_Pulldown(NMOS)
		_Nor_Pbody_NumCont                          = 2,  # Number
		_Nor_Pbody_XvtTop2Pbody                     = None,  # Number/None(Minimum)
		# Nbody_Pullup(PMOS)
		_Nor_Nbody_NumCont                          = 2,  # Number
	...
	def _CalculateDesignParameter(self,
	                              ...
	                              # Pulldown(NMOS)
	                              # Physical dimension
	                              _Nor_NMOS_ChannelWidth	= 350,      # Number
	                              _Nor_NMOS_NumberofGate                  = 3,
	                              # Poly Gate setting
	                              # Poly Gate setting : vertical length
	                              _Nor_NMOS_POGate_Comb_length            =None,#  Number
	                              # Pulldown(PMOS)
	                              # Physical dimension
	                              _Nor_PMOS_ChannelWidth	                = 350,      #  r
	                              _Nor_PMOS_NumberofGate                  = 12,
	                              # Source_node setting
	                              _Nor_PMOS_Source_Via_Close2POpin_TF     =False,  # True/False --> First MOS
	                              # Poly Gate setting
	                              # Poly Gate setting : vertical length
	                              _Nor_PMOS_POGate_Comb_length            = None,      #  Number
		...
		_Caculation_Parameters['_NMOS_NumberofGate'] = _Nor_NMOS_NumberofGate
		...
		_Caculation_Parameters['_PMOS_NumberofGate'] = _Nor_PMOS_NumberofGate
...
if __name__ == '__main__':
	...
	InputParams = dict(
		...
		# Num of Input
		_Nor_Num_Input      = 4,  # Number>2
		
		# MOSFET
			# Common
		_Nor_ChannelLength	= 30,       # Number
		_Nor_POGate_ViaMxMx = [0, 3],  # Ex) [1,5] -> ViaM1M5
		_Nor_XVT			= 'SLVT'  ,   # 'XVT' ex)SLVT/LVT/RVT/HVT
			# Pulldown(NMOS)
				# Physical dimension
		_Nor_NMOS_ChannelWidth	                = 400,      # Number
		_Nor_NMOS_NumberofGate                  = 1,
				# Poly Gate setting
					# Poly Gate setting : vertical length
		_Nor_NMOS_POGate_Comb_length            = None,      # None/Number
			# Pulldown(PMOS)
