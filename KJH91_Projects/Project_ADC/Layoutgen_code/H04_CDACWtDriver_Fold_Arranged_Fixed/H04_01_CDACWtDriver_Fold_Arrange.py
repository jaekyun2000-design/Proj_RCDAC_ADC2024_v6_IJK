...
from KJH91_Projects.Project_ADC.Layoutgen_code.H04_CDACWtDriver_Fold_Arranged_Fixed import H04_00_CDACWtDriver_Fold_Arrange_parts
...
## CDAC
    ...
    ## CDAC
        ...
        _Caculation_Parameters0 = copy.deepcopy(H04_00_CDACWtDriver_Fold_Arrange_parts._CDACWtDriver._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_CDAC_LowerHalf'] = self._SrefElementDeclaration(_DesignObj=H04_00_CDACWtDriver_Fold_Arrange_parts._CDACWtDriver(_DesignParameter=None,_Name='{}:SRF_CDAC_LowerHalf'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_CDAC_UpperHalf'] = copy.deepcopy(self._DesignParameter['SRF_CDAC_LowerHalf']['_DesignObj']._DesignParameter['SRF_CapArray'])
        self.rename_srf_prefix(self._DesignParameter['SRF_CDAC_LowerHalf']['_DesignObj']._DesignParameter['SRF_CapArray'], 'SRF_CDAC_LowerHalf', 'SRF_CDAC_UpperHalf')
        ...
        ## Approaching_coord
        tmp2 = self.get_param_KJH4('SRF_CDAC_UpperHalf','SRF_DummyCaps', 'SRF_CapWtShield4DCAP','BND_Shield_Extend_VTC_M{}'.format(_CDAC_LayoutOption[-1]))
        ...
        for i in range(_NumOfBits):
            ...
            if i == _NumOfBits - 1:  # 마지막 for loop 사이클 -> Dummy Vtc Output Path (최내측) 생성 "BND_CDACFold1_B-1_DrvOutput_Vtc_M2"
                ...
                self._DesignParameter['BND_CDACFold1_B{}_DrvOutput_Vtc_M2'.format(_NumOfBits - 1 -  i)]['_YWidth'] = abs(tmp1[0][0][0]['_XY_cent'][1] - tmp2[0][0][0][0][0]['_XY_cent'][1]) + 100   # Hrz_M5_PathWidth
                ...
                self._DesignParameter['BND_CDACFold1_B{}_DrvOutput_Vtc_M2'.format(_NumOfBits - 1 -  i)]['_YWidth'] = abs(tmp1[0][0][0]['_XY_cent'][1] - tmp2[0][0][0][0]['_XY_cent'][1]) + 100   # Hrz_M5_PathWidth
        ...
        ###################################################################################################################
                ...
                self._DesignParameter['SRF_DrvOutputViaM2M3'] = \
                    self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,_Name='{}:SRF_DrvOutputViaM2M3'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_CDACTopNode_ViaM8M9'] = \
            self._SrefElementDeclaration(_DesignObj=A02_ViaM8toM9_YJH._ViaM8toM9_YJH(_DesignParameter=None,_Name='{}:SRF_CDACTopNode_ViaM8M9'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_H04_01_CDACWtDriver_Fold_Arranged'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'HH04_01_CDACWtDriver_Fold_Arranged'
