...
## CDAC
    ...
    ## CDAC
        ...
        _Caculation_Parameters0['_Bitsize'] =_NumOfBits-1 ## For Fold Array
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_H04_00_CDACWtDriver_Fold_Arranged_parts'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'H04_00_CDACWtDriver_Fold_Arranged_parts'
...
## CDAC
    ...
    ## CDAC
            ...
            ## Dummy Cap Option
            _CDAC_NumOfDummyCaps=15,  # Number, Number of dummy cap(one side)
            _CDAC_DummyCap_TopBottomShort=None,  # True => Top - Bottom Short, False -> Bottom = GND, None => Floating Bottom Node
