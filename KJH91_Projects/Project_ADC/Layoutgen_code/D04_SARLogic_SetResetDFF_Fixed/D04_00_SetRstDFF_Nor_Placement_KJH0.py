...
from KJH91_Projects.Project_ADC.Layoutgen_code.D01_SARLogic_XmissionGate_Fixed import D01_00_Xgate_KJH
from KJH91_Projects.Project_ADC.Layoutgen_code.D02_SARLogic_Nor_Fixed import D02_02_Nor_KJH0
...
## SetResetDFF
    ...
    ## Slave Inv3 : Qb driver
        ...
        _Caculation_Parameters['_XVT']                              = _Mst_Xgate1_XVT
        ...
        tmp1 = self.get_param_KJH4('SRF_Mst_Xgate1','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate1_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Mst_Xgate1','SRF_NMOS','BND_{}Layer'.format(_Mst_Xgate1_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D01_00_Xgate_KJH._Xgate._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT'] = _Mst_Xgate2_XVT
        ...
        target_coordx = tmp1_1[0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Xgate1','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate1_XVT))
        ...
        approaching_coordx = tmp2_1[0][0][-1][0]['_XY_right'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Mst_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate2_XVT))
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Mst_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate2_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Mst_Xgate2','SRF_NMOS','BND_{}Layer'.format(_Mst_Xgate2_XVT))
        ...
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                                = _Mst_Nor1_XVT
        ...
        _Caculation_Parameters['_NMOSAB_Pbody_XvtTop2Pbody']           = None
        _Caculation_Parameters['_PMOSAB_Nbody_Xvtdown2Nbody']          = None
        _Caculation_Parameters['_PMOSXvt2NMOSXvt']                     = _DFF_PMOSXvt2NMOSXvt
        ...
        target_coordx = tmp1_1[0][0][0][0]['_XY_left'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate2_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Mst_Nor1','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Mst_Nor1_XVT))
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Mst_Nor1','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Mst_Nor1_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Mst_Nor1','SRF_Pulldown','SRF_NMOSA','BND_{}Layer'.format(_Mst_Nor1_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D02_02_Nor_KJH0._Nor._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                                = _Mst_Nor2_XVT
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Nor1','SRF_Pullup','SRF_PMOSB','BND_{}Layer'.format(_Mst_Nor1_XVT))
        ...
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Mst_Nor2','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Mst_Nor2_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Mst_Nor2','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Mst_Nor2_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Mst_Nor2','SRF_Pulldown','SRF_NMOSA','BND_{}Layer'.format(_Mst_Nor2_XVT))
        ...
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                          = _Mst_Inv1_XVT
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Nor2','SRF_Pullup','SRF_PMOSB','BND_{}Layer'.format(_Mst_Nor2_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Mst_Inv1','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv1_XVT))
        approaching_coordy = tmp2_2[0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Mst_Inv1','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv1_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Mst_Inv1','SRF_NMOS','BND_{}Layer'.format(_Mst_Inv1_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D00_00_Inverter_KJH._Inverter._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                          = _Mst_Inv2_XVT
        ...
        target_coordx = tmp1_1[0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Inv1','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv1_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Mst_Inv2','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv2_XVT))
        approaching_coordy = tmp2_2[0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Mst_Inv2','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv2_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Mst_Inv2','SRF_NMOS','BND_{}Layer'.format(_Mst_Inv2_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D00_00_Inverter_KJH._Inverter._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                              = _Mst_Inv3_XVT
        ...
        target_coordx = tmp1_1[0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Inv2','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv1_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Mst_Inv3','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv2_XVT))
        approaching_coordy = tmp2_2[0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Mst_Inv3','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv3_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Mst_Inv3','SRF_NMOS','BND_{}Layer'.format(_Mst_Inv3_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D01_00_Xgate_KJH._Xgate._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT'] = _Slv_Xgate1_XVT
        ...
        target_coordx = tmp1_1[0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Inv3','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv3_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate1_XVT))
        approaching_coordy = tmp2_2[0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate1_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Slv_Xgate1','SRF_NMOS','BND_{}Layer'.format(_Slv_Xgate1_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D01_00_Xgate_KJH._Xgate._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT'] = _Slv_Xgate2_XVT
        ...
        target_coordx = tmp1_1[0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate1_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][-1][0]['_XY_right'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate2_XVT))
        approaching_coordy = tmp2_2[0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate2_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Slv_Xgate2','SRF_NMOS','BND_{}Layer'.format(_Slv_Xgate2_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D02_02_Nor_KJH0._Nor._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                                = _Slv_Nor1_XVT
        ...
        target_coordx = tmp1_1[0][0][0][0]['_XY_left'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate2_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Nor1','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Slv_Nor1_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Slv_Nor1','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Slv_Nor1_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Slv_Nor1','SRF_Pulldown','SRF_NMOSA','BND_{}Layer'.format(_Slv_Nor1_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D02_02_Nor_KJH0._Nor._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                                = _Slv_Nor2_XVT
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Nor1','SRF_Pullup','SRF_PMOSB','BND_{}Layer'.format(_Slv_Nor1_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Nor2','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Slv_Nor2_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Slv_Nor2','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Slv_Nor2_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Slv_Nor2','SRF_Pulldown','SRF_NMOSA','BND_{}Layer'.format(_Slv_Nor2_XVT))
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Slv: Inv1: ReSet pre-driver
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(D00_00_Inverter_KJH._Inverter._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                              = _Slv_Inv1_XVT
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Nor2','SRF_Pullup','SRF_PMOSB','BND_{}Layer'.format(_Slv_Nor2_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Inv1','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv1_XVT))
        approaching_coordy = tmp2_2[0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Slv_Inv1','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv1_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Slv_Inv1','SRF_NMOS','BND_{}Layer'.format(_Slv_Inv1_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D00_00_Inverter_KJH._Inverter._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                              = _Slv_Inv2_XVT
        ...
        target_coordx = tmp1_1[0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Inv1','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv1_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Inv2','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv2_XVT))
        approaching_coordy = tmp2_2[0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Slv_Inv2','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv2_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Slv_Inv2','SRF_NMOS','BND_{}Layer'.format(_Slv_Inv2_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D00_00_Inverter_KJH._Inverter._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                              = _Slv_Inv3_XVT
        ...
        target_coordx = tmp1_1[0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Inv2','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv1_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Inv3','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv2_XVT))
        approaching_coordy = tmp2_2[0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Slv_Inv3','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv3_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Slv_Inv3','SRF_NMOS','BND_{}Layer'.format(_Slv_Inv3_XVT))
        ...
        target_coordx = max(tmp1_1[0][0][-1][0]['_XY_right'][0], tmp1_2[0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Mst_Xgate1','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate1_XVT))
        ...
        approaching_coordx = min(tmp2_1[0][0][-1][0]['_XY_right'][0],tmp2_2[0][0][-1][0]['_XY_right'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Mst_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate2_XVT))
        ...
        target_coordx = max(tmp1_1[0][0][0][0]['_XY_left'][0],tmp1_2[0][0][0][0]['_XY_left'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Mst_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate2_XVT))
        target_coordy = tmp1_3[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Mst_Nor1','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Mst_Nor1_XVT))
        ...
        target_coordx = max(tmp1_1[0][0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Mst_Nor1','SRF_Pullup','SRF_PMOSB','BND_{}Layer'.format(_Mst_Nor1_XVT))
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Mst_Nor2','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Mst_Nor2_XVT))
        approaching_coordy = tmp2_3[0][0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Mst_Nor2','SRF_Pullup','SRF_PMOSB','BND_{}Layer'.format(_Mst_Nor2_XVT))
        target_coordy = tmp1_3[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Mst_Inv1','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv1_XVT))
        approaching_coordy = tmp2_3[0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Mst_Inv1','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv1_XVT))
        target_coordy = tmp1_3[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Mst_Inv2','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv2_XVT))
        approaching_coordy = tmp2_3[0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Mst_Inv2','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv1_XVT))
        target_coordy = tmp1_3[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Mst_Inv3','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv2_XVT))
        approaching_coordy = tmp2_3[0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Mst_Inv3','SRF_PMOS','BND_{}Layer'.format(_Mst_Inv3_XVT))
        target_coordy = tmp1_3[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate1_XVT))
        approaching_coordy = tmp2_3[0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate1_XVT))
        target_coordy = tmp1_3[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][-1][0]['_XY_right'][0],tmp2_2[0][0][-1][0]['_XY_right'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate2_XVT))
        approaching_coordy = tmp2_3[0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][0][0]['_XY_left'][0],tmp1_2[0][0][0][0]['_XY_left'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate2_XVT))
        target_coordy = tmp1_3[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Slv_Nor1','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Slv_Nor1_XVT))
        approaching_coordy = tmp2_3[0][0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Slv_Nor1','SRF_Pullup','SRF_PMOSB','BND_{}Layer'.format(_Slv_Nor1_XVT))
        target_coordy = tmp1_3[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Slv_Nor2','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Slv_Nor2_XVT))
        approaching_coordy = tmp2_3[0][0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Slv_Nor2','SRF_Pullup','SRF_PMOSB','BND_{}Layer'.format(_Slv_Nor2_XVT))
        target_coordy = tmp1_3[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Slv_Inv1','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv1_XVT))
        approaching_coordy = tmp2_3[0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Slv_Inv1','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv1_XVT))
        target_coordy = tmp1_3[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Slv_Inv2','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv2_XVT))
        approaching_coordy = tmp2_3[0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = max(tmp1_1[0][0][-1][0]['_XY_right'][0],tmp1_2[0][0][-1][0]['_XY_right'][0])
                                ##y
        tmp1_3 = self.get_param_KJH4('SRF_Slv_Inv2','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv1_XVT))
        target_coordy = tmp1_3[0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = min(tmp2_1[0][0][0][0]['_XY_left'][0],tmp2_2[0][0][0][0]['_XY_left'][0])
                                ##Y
        tmp2_3 = self.get_param_KJH4('SRF_Slv_Inv3','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv2_XVT))
        approaching_coordy = tmp2_3[0][0][0][0]['_XY_down'][1]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_D04_00_SetRstDFF_Nor_Placement_Fixed'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'D04_00_SetRstDFF_Nor_Placement_v0_99'
