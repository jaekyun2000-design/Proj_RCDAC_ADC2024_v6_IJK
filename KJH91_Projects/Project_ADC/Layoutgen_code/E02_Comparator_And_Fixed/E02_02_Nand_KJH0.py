...
from KJH91_Projects.Project_ADC.Layoutgen_code.E02_Comparator_And_Fixed import E02_00_Pulldown_KJH0
from KJH91_Projects.Project_ADC.Layoutgen_code.E02_Comparator_And_Fixed import E02_01_Pullup_KJH0
...
## Nand
    ...
    # Height
        ...
        _Caculation_Parameters = copy.deepcopy(E02_00_Pulldown_KJH0._Pulldown._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Pulldown'] = self._SrefElementDeclaration(_DesignObj=E02_00_Pulldown_KJH0._Pulldown(_DesignParameter=None, _Name='{}:SRF_Pulldown'.format(_Name)))[0]
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Pullup Gen.
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_PMOSA_power_v2._PMOSA_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(E02_01_Pullup_KJH0._Pullup._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_PMOSAPOWER_PbodyContact_1_Length']  = _PMOSAPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_XVT']                  = _XVT
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Pullup'] = self._SrefElementDeclaration(_DesignObj=E02_01_Pullup_KJH0._Pullup(_DesignParameter=None, _Name='{}:SRF_Pullup'.format(_Name)))[0]
        ...
        if _NMOSAB_Pbody_XvtTop2Pbody == None:
                            ## Calculate
                                ## Target_coord: _XY_type1
                                    ## X
            tmp1_1 = self.get_param_KJH4('SRF_Pulldown','SRF_NMOSA', 'BND_{}Layer'.format(_XVT))
            ...
            self._DesignParameter['SRF_Pbody']['_XYCoordinates'] = tmpXY
                            ...
                            ## Calculate
                                ## Target_coord: _XY_type1
            tmp1 = self.get_param_KJH4('SRF_Pulldown','SRF_NMOSA','BND_{}Layer'.format(_XVT))
        ...
        if _PMOSAB_Nbody_Xvtdown2Nbody == None:
                            ## Calculate
                                ## Target_coord: _XY_type1
                                    ## X
            tmp1_1 = self.get_param_KJH4('SRF_Pullup', 'SRF_PMOSA', 'BND_{}Layer'.format(_XVT))
            target_coordx = tmp1_1[0][0][0][0]['_XY_left'][0]
                                    ## Y
        ...
        ## Define Boundary_element _YWidth : ViaYmin 기준
        tmp1 = self.get_param_KJH4('SRF_Pullup', 'SRF_PMOSB', 'BND_Source_M1')
        tmp2 = self.get_param_KJH4('SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        self._DesignParameter['BND_PMOSB_Source_Vtc_M1']['_YWidth'] = abs(tmp1[0][0][0][0]['_XY_up'][1] - tmp2[0][0][0][0]['_XY_down'][1])

        ## Define Boundary_element _XWidth
        tmp = self.get_param_KJH4('SRF_Pullup', 'SRF_PMOSB', 'BND_Source_M1')
        ...
        ## Define Boundary_element _XWidth
            # Most right
        tmp1 = self.get_param_KJH4('SRF_Pulldown','SRF_NMOSB','BND_PODummyLayer')
        tmp2 = self.get_param_KJH4('SRF_Pullup','SRF_PMOSB','BND_PODummyLayer')
        ...
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        self._DesignParameter['BND_NMOSA_Drain_M2_Exten'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL2'][0],
            _Datatype=DesignParameters._LayerMapping['METAL2'][1],
            _XWidth=None,
            _YWidth=None,
        ...
        if tmp1[0][0][-1][0]['_XY_right'][0] > tmp2[0][0][-1][0]['_XY_right'][0]:
            ...
            # Xwidth
        tmp = self.get_param_KJH4('SRF_Pulldown','SRF_NMOSA','BND_Drain_Hrz_M2')
        self._DesignParameter['BND_NMOSA_Drain_M2_Exten']['_XWidth'] = abs(most_right - tmp[0][0][0][0]['_XY_left'][0])

        ## Define Boundary_element _YWidth
        self._DesignParameter['BND_NMOSA_Drain_M2_Exten']['_YWidth'] = 50

        ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_NMOSA_Drain_M2_Exten']['_XYCoordinates'] = [[0, 0]]
        ...
        self._DesignParameter['BND_NMOSA_Drain_M2_Exten']['_XYCoordinates'] = [[0, 0]]
                        ## Calculate
                            ## Target_coord: _XY_type1
        tmp1 = self.get_param_KJH4('SRF_Pulldown','SRF_NMOSA','BND_Drain_Hrz_M2')
        target_coord = tmp1[0][0][0][0]['_XY_down_left']
                            ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('BND_NMOSA_Drain_M2_Exten')
        approaching_coord = tmp2[0][0]['_XY_down_left']
                            ## Sref coord
        tmp3 = self.get_param_KJH4('BND_NMOSA_Drain_M2_Exten')
        Scoord = tmp3[0][0]['_XY_origin']
                            ## Cal
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
                    ## Define Coordinates
        self._DesignParameter['BND_NMOSA_Drain_M2_Exten']['_XYCoordinates'] = tmpXY
        ...
        ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('BND_NMOSA_Drain_M2_Exten')
        tmp2 = self.get_param_KJH4('BND_PMOSB_Drain_M2_Exten')
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_E02_02_Nand_Fixed'
