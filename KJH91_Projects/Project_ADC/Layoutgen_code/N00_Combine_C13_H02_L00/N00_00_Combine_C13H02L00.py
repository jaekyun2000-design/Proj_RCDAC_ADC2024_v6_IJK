...
## Define Class
class _C13H02L00(StickDiagram_KJH1._StickDiagram_KJH):
...
if __name__ == '__main__':
    ...
    libname = 'Proj_RcdacSar_N00_C13H02L00'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'N00_00_C13H02L00'
    ...
    InputParams = dict(
        ...
        ## Inverter Chain
        ## Inv1 common
        _CDACPreDriver_NumberofGate=[[8, 32],[8, 32],[8, 32],[8, 16, 32],[8, 16, 32],[8, 16, 32],[8, 16, 32],[8, 16, 32]],  # Vector
        _CDACPreDriver_ChannelLength=30,  # Scalar
        _CDACPreDriver_XVT='SLVT',  # 'SLVT'
    ...
    ## Gen Object:
    LayoutObj = _C13H02L00(_DesignParameter=None, _Name=cellname)
