...
class _Inv(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    # Xgate
        ...
        _Inv_NMOS_POGate_Comb_length  = 100,
        ...
        # PMosfet
            ...
            # Poly Gate setting
                # Poly Gate setting : vertical length
            _Inv_PMOS_POGate_Comb_length         = 100,     # None/Number
                # Poly Gate Via setting :
            _Inv_PMOS_POGate_ViaMxMx             = [0 ,1],     # Ex) [1,5] -> ViaM1M5

        # Power Rail
            # Pbody_Pulldown(NMOS)
        _Inv_Pbody_NumCont=2,  # Number
        _Inv_Pbody_XvtTop2Pbody=None,  # Number/None(Minimum)
            # Nbody_Pullup(PMOS)
        _Inv_Nbody_NumCont=2,  # Number
