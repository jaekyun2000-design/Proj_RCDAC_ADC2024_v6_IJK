...
from KJH91_Projects.Project_ADC.Layoutgen_code.H01_CDAC_Driver_v2_YJH_RCHybrid_Fixed import H01_01_DriverArray_CommonCentroid_Decimation
...
## CDAC
    ...
    ## CDAC
        ...
        _Caculation_Parameters0 = copy.deepcopy(H01_01_DriverArray_CommonCentroid_Decimation._DriverArray._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_DriverArray'] = self._SrefElementDeclaration(_DesignObj=H01_01_DriverArray_CommonCentroid_Decimation._DriverArray(_DesignParameter=None,_Name='{}:SRF_DriverArray'.format(_Name)))[0]
        ...
        for j in range(_NumOfBits):
            ...
            ## Calculate
            tmpXY = []
            tmp = len(self._DesignParameter['SRF_DriverArray']['_DesignObj']._DesignParameter['SRF_{}C_DriverCell'.format(CapSize)]['_XYCoordinates'])
            for i in range(tmp):
                ## Target_coord: _XY_type1
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_H03_00_CDACWtDriver_Unfold_CommonCent'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'H03_00_CDACWtDriver_Unfold_CommonCent'
