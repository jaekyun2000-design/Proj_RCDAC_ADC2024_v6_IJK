    ...
    ## Inverter Chain
        ...
        for j in range(0,len(_NumberofGate)):
            ...
            if j ==0:
                ...
                New_Scoord[0] = New_Scoord[0] + _Buf2BufDistance
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_J00_02_CDAC_PreDriver_Fixed'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'J00_02_CDAC_PreDriver_v0_99'
