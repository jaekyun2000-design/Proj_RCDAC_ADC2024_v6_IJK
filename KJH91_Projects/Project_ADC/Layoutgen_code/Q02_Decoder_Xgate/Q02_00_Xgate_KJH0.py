...
class _Xgate(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    # Xgate
        ...
        _Xgate_NMOS_POGate_Comb_length  = 100,
        ...
        # PMosfet
            ...
            # Poly Gate setting
                # Poly Gate setting : vertical length
            _Xgate_PMOS_POGate_Comb_length         = 100,     # None/Number
                # Poly Gate Via setting :
            _Xgate_PMOS_POGate_ViaMxMx             = [0 ,1],     # Ex) [1,5] -> ViaM1M5

        # Power Rail
            # Pbody_Pulldown(NMOS)
        _Xgate_Pbody_NumCont=2,  # Number
        _Xgate_Pbody_XvtTop2Pbody=None,  # Number/None(Minimum)
            # Nbody_Pullup(PMOS)
        _Xgate_Nbody_NumCont=2,  # Number
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_Q02_00_Xgate'
