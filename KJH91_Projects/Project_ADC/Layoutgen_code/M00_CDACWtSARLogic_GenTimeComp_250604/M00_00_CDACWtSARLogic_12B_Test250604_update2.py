...
class _CDACWtSARLogic(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    _ParametersForDesignCalculation = dict(
		...
		# Tr1 and Tr2
		# Tr1
		_Samp_Tr1_NumberofGate=4,  # number
		_Samp_Tr1_ChannelWidth=1000,  # number
		_Samp_Tr1_ChannelLength=30,  # number
		_Samp_Tr1_XVT='HVT',  # 'XVT' ex)SLVT LVT RVT HVT
		...
		_Samp_HDVNCAP_NumFigPair=62,  # 9.55u M == 94개
...
if __name__ == '__main__':
    ...
    cellname = 'M00_00_CDACWtSARLogic_fold12_RenameVersion2'
    ...
    InputParams = dict(
        ...
        ## StrongARM Latch
        _Comp_SALatch_CLKinputPMOSFinger1=4,  # random.randint(1, 15),  # 6
        _Comp_SALatch_CLKinputPMOSFinger2=4,  # random.randint(1, 15),  # 3
        _Comp_SALatch_PMOSFinger=1,  # random.randint(1, 15),  # 3
        ...
        _Comp_SALatch_NMOSFinger=15,  # random.randint(1, 15),  # 2
        _Comp_SALatch_CLKinputNMOSFinger=1,  # random.randint(1, 15),  # 8
        ...
        _Comp_SALatch_ChannelLength=60,  # random.randrange(30, 60, 2),  # 30
        ...
        ## StrongARMLatch Output Buffer Sizing
        # Inverter1
        _Comp_SAOutBuf_Inv1_NMOS_ChannelWidth=600,  # Number
        _Comp_SAOutBuf_Inv1_NMOS_ChannelLength=30,  # Number
        _Comp_SAOutBuf_Inv1_NMOS_NumberofGate=42,  # Number
        ...
        _Comp_SAOutBuf_Inv1_PMOS_ChannelWidth=1200,  # Number
        _Comp_SAOutBuf_Inv1_PMOS_ChannelLength=30,  # Number
        _Comp_SAOutBuf_Inv1_PMOS_NumberofGate=42,  # Number
        ...
        # Inverter2
        _Comp_SAOutBuf_Inv2_NMOS_ChannelWidth=600,  # Number
        ...
        _Comp_SAOutBuf_Inv2_PMOS_ChannelWidth=1200,  # Number
        ...
        ## SR Latch Size
        _Comp_SRLatch_NAND_NMOS_ChannelWidth=600,  # Number
        ...
        _Comp_SRLatch_NAND_PMOS_ChannelWidth=1200,  # Number
