...
class _CDACWtSARLogic(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    _ParametersForDesignCalculation = dict(
        ...
        # Tr1 and Tr2
        # Tr1
        _Samp_Tr1_NumberofGate=10,  # number
        _Samp_Tr1_ChannelWidth=2000,  # number
        _Samp_Tr1_ChannelLength=30,  # number
        _Samp_Tr1_XVT='RVT',  # 'XVT' ex)SLVT LVT RVT HVT

        # Tr2
        _Samp_Tr2_NumberofGate=2,  # number
...
if __name__ == '__main__':
    ...
    cellname = 'M00_00_CDACWtSARLogic_fold10_Renameversion2'
